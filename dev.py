...
def blenderkit_client_build(abs_build_dir: str):
    ...
    builds = [
        ...
        {
            "env": {"GOOS": "windows", "GOARCH": "arm64", "CGO_ENABLED": "1"},
            "output": os.path.join(
        ...
        {
            "env": {"GOOS": "linux", "GOARCH": "amd64", "CGO_ENABLED": "1", "CC": "x86_64-linux-musl-gcc"},
            "output": os.path.join(
